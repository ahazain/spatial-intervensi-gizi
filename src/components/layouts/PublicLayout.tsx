...
const PublicLayout: React.FC = () => {
  ...
  const menuItems = [
    ...
    { name: 'Statistik', path: '/statistics', icon: <BarChart3 size={18} className="mr-2" /> },
  ];
        ...
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-4 md:mb-0">
              <h3 className="text-sm font-semibold text-gray-700">Sistem Informasi Spasial Intervensi Gizi</h3>
              <p className="mt-2 text-sm text-gray-500">
                Kota Surabaya &copy; {new Date().getFullYear()}
              </p>
            </div>
            <div>
              <h3 className="text-sm font-semibold text-gray-700">Link Terkait</h3>
              <ul className="mt-2 space-y-2">
                <li>
                  <a href="https://surabaya.go.id" className="text-sm text-teal-600 hover:text-teal-700">
