...
//     useState<HealthFacility | null>(null);

//   const filteredChildren = useMemo(() => {
//     return children.filter((child: Child) => {
//       // hapus pengecekan user role dan district
...
//       }
//       if (
//         child.nutritionStatus === "severely_underweight" &&
//         !filters.showSeverelyUnderweight
//       ) {
//         return false;
//       }
...
//     const childrenOutsideBuffer =
//       filteredChildren.length - childrenWithinBuffer;
//     const coveragePercentage =
//       (childrenWithinBuffer / filteredChildren.length) * 100;
...
//                       {analysisStats.percentage.toFixed(1)}%
//                     </span>
//                   </div>
...
//                   Buffer 1km menunjukkan jangkauan layanan optimal dari
//                   fasilitas kesehatan. Balita yang berada dalam jangkauan buffer
//                   memiliki akses yang lebih baik ke layanan kesehatan.
//                 </p>
...
//                     <span className="text-sm font-medium">
//                       <StatusBadge
//                         status={selectedChild.nutritionStatus}
//                         size="sm"
//                       />
//                     </span>
//                   </div>
...
//                     <span className="text-sm font-medium">
//                       {selectedChild.district}
//                     </span>
//                   </div>
//                   <div className="grid grid-cols-2">
//                     <span className="text-sm text-gray-500">Koordinat:</span>
//                     <span className="text-sm font-medium">
//                       {selectedChild.coordinates[0].toFixed(6)},{" "}
//                       {selectedChild.coordinates[1].toFixed(6)}
//                     </span>
//                   </div>
//                 </div>
//               </CardContent>
...
//                     <span className="text-sm font-medium">
//                       {selectedFacility.type === "puskesmas"
//                         ? "Puskesmas"
//                         : "Pustu"}
//                     </span>
//                   </div>
...
//                     <span className="text-sm font-medium">
//                       {selectedFacility.capacity} pasien
//                     </span>
//                   </div>
//                   <div className="grid grid-cols-2">
//                     <span className="text-sm text-gray-500">Koordinat:</span>
//                     <span className="text-sm font-medium">
//                       {selectedFacility.coordinates[0].toFixed(6)},{" "}
//                       {selectedFacility.coordinates[1].toFixed(6)}
//                     </span>
//                   </div>
//                 </div>
//               </CardContent>
