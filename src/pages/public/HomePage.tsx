    ...
    <div className="bg-white">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
              ...
              <span className="block text-teal-300">
                Intervensi Gizi Surabaya
              </span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl text-teal-100">
              Memantau dan menganalisis status gizi anak di Kota Surabaya dengan
              visualisasi spasial untuk intervensi yang lebih tepat sasaran.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="max-w-xl mt-5 mx-auto text-xl text-gray-500">
              Sistem berbasis spasial untuk memudahkan pemantauan dan analisis
              status gizi anak di Kota Surabaya.
            </p>
          </div>
                ...
                <div className="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-500">
                      Visualisasi sebaran kasus gizi buruk, kurang, dan stunting
                      di seluruh kecamatan Surabaya secara interaktif.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-500">
                      Informasi lokasi puskesmas dan pustu di Kota Surabaya
                      lengkap dengan jangkauan layanan 1 km.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <p className="mt-5 text-base text-gray-500">
                      Visualisasi data dan tren kasus gizi dalam bentuk grafik
                      dan statistik yang informatif.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-gray-50 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 space-y-8 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:grid-cols-2 lg:max-w-4xl lg:mx-auto">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              <div className="bg-teal-50 px-6 py-4 border-b border-gray-200">
                <div className="flex items-center">
                  <Shield className="h-6 w-6 text-teal-700" />
                  <h3 className="ml-2 text-lg font-medium text-teal-900">
                    Admin
                  </h3>
                </div>
              </div>
              <div className="px-6 py-4">
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex items-start">
                    <svg
                      className="h-5 w-5 text-teal-500 mt-0.5 mr-2"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
      ...
      <div className="bg-teal-700">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-teal-300">Akses lebih lengkap.</span>
          </h2>
